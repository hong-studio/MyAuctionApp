...
public class Tab3Page2RecyclerAdapter extends RecyclerView.Adapter<Tab3Page2RecyclerAdapter.VH> {

    Context context;
    ArrayList<Item> items;

    public Tab3Page2RecyclerAdapter(Context context, ArrayList<Item> items) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView= inflater.inflate(R.layout.recycler_item_tab3page2, parent, false);

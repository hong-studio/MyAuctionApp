...
public class Tab1Page1RecyclerAdapter extends RecyclerView.Adapter<Tab1Page1RecyclerAdapter.VH> {

    Context context;
    ArrayList<Item> items;

    public Tab1Page1RecyclerAdapter(Context context, ArrayList<Item> items) {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView= inflater.inflate(R.layout.recycler_item_tab1page1, parent, false);
